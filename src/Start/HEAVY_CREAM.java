 ...
 * @author Windows 1021
 */
public class HEAVY_CREAM extends javax.swing.JFrame {

    /**
     * Creates new form HEAVY_CREAM
     */
    public HEAVY_CREAM() {
        initComponents();
        ...
        if (txtMasukan.getText().isEmpty()) {
            ...
            try {
                ...
                if((awal.equalsIgnoreCase("grams (g)")) && (akhir.equalsIgnoreCase("grams (g)"))){
                    ...
                    long roundedValue = Math.round(GtoG);
                    String result = decimalFormat.format(GtoG);
                    txtHasil.setText(result);
                    txtHistori.setText(null);
                    ...
                    long roundedValue = Math.round(GtoOZ);
                    String result = decimalFormat.format(GtoOZ);
                    txtHasil.setText(result);
                    txtHistori.setText(null);
                    ...
                    long roundedValue = Math.round(GtoLB);
                    String result = decimalFormat.format(GtoLB);
                    txtHasil.setText(result);
                    txtHistori.setText(null);
    ...
    private void ListBahanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ListBahanMouseClicked
        ...
        switch (selectedOption) {
            ...
            case "Sirup Jagung":
                ...
                break;
            case "Heavy Cream":
                JOptionPane.showMessageDialog(this, "Anda telah memsauki program tersebut");
                break;
            case "Mentega":
                close();
