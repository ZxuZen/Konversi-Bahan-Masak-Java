 ...
 * @author Windows 1021
 */
public class Sirup_jagung extends javax.swing.JFrame {

    /**
     * Creates new form Sirup_jagung
     */
    public Sirup_jagung() {
        initComponents();
        ...
        if (txtMasukan.getText().isEmpty()) {
            ...
            try {
                ...
                if((awal.equalsIgnoreCase("grams (g)")) && (akhir.equalsIgnoreCase("grams (g)"))){
                    ...
                    long roundedValue = Math.round(LBtoLB);
